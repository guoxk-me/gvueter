...
const payload = computed<TooltipEntry[]>(() => {
  const payloadFill = typeof props.payload.fill === 'string' ? props.payload.fill : undefined
    ...
    return [
      {
        ...
        value,
        itemConfig,
        indicatorColor: itemConfig.color ?? payloadFill,
      },
    ]
  })
})
